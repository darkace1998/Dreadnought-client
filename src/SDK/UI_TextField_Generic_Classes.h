...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_TextField_Generic.UI_TextField_Generic_C
	 * Size -> 0x0030 (FullSize[0x0270] - InheritedSize[0x0240])
	 */
	class UUI_TextField_Generic_C : public UUI_DreadWidget
	{
	public:
		...
		class UMultiLineEditableText*                              TextField;                                               // 0x0258(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_UI_TextField_Generic(int32_t EntryPoint);
		void OnClicked__DelegateSignature(class UUI_TextField_Generic_C* source);
