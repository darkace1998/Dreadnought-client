...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_Popup_CreditsToGPDetails.UI_Popup_CreditsToGPDetails_C
	 * Size -> 0x0088 (FullSize[0x0300] - InheritedSize[0x0278])
	 */
	class UUI_Popup_CreditsToGPDetails_C : public UUI_DreadPopup
	{
	public:
		...
		class UTextBlock*                                          CreditsCost;                                             // 0x0290(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_UI_Popup_CreditsToGPDetails(int32_t EntryPoint);
